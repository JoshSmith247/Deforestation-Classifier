...
2. **Applies that model** to a bounding box of yearly satellite imagery of the Amazon (2015–2023) to measure how much forest has been lost over time
...
**Run the all-including demo script!**
```bash
python RUN_ME.py
```
